module.exports = {
    ...
    plugins: ['@typescript-eslint', 'jest', 'jsdoc', 'import', 'prefer-arrow', 'unicorn'],
    overrides: [
        {
            files: ['**/*.ts', '**/*.tsx'],
            ...
            rules: {
                ...
                '@typescript-eslint/explicit-function-return-type': [ // I suggest this setting for requiring return types on functions only where useful
                    'warn',
                    {
